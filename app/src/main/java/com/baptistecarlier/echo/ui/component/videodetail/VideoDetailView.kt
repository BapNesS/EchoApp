...
fun VideoDetailScreenPreview_Loading() {
    EchoTheme {
        VideoDetailView(state = VideoDetailUiState(isLoading = true), {}, { _, _, _ -> })
    }
}
...
fun VideoDetailScreenPreview_Error() {
    EchoTheme {
        VideoDetailView(state = VideoDetailUiState(isError = true), {}, { _, _, _ -> })
    }
}
...
fun VideoDetailScreenPreview_NullItem() {
    EchoTheme {
        VideoDetailView(state = VideoDetailUiState(linkedInViewItem = null), {}, { _, _, _ -> })
    }
}
